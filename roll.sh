...
version='1.1'
rick='https://raw.githubusercontent.com/NQuackenboss/rickrollrc/master/assets'
...
audpid=0
NEVER_GONNA='curl -s -L https://raw.githubusercontent.com/NQuackenboss/rickrollrc/master/roll.sh | bash'
